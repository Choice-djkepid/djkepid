...
<!-- Mirrored from www.kepid.co.kr/kepid/investment/stock.asp?stock=stock2 by HTTrack Website Copier/3.x [XR&CO'2010], Tue, 28 Aug 2012 06:24:26 GMT -->
<head>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" style="background:url(img/right_img.gif) no-repeat top right">
  <tr>
...
<table width="590" height="27" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td background="img/img09.gif"><table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="stock0a30.php?stock=stock1" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','img/tab01on.gif',1)"><img src="img/tab01.gif" name="Image8" width="93" height="27" border="0"></a></td>
          <td><img src="img/tab02on.gif" name="Image9" width="90" height="27" border="0"></td>
        </tr>
      </table></td>
  </tr>
</table>
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><iframe src="http://datamall.koscom.co.kr/servlet/cyberir/CyberIrFlexDailyServlet?screenId=301003&amp;simplecode=130660&amp;ptype=2" width="640" height="940" frameborder="0" scrolling="no" title="한전산업개발 일자별주가" ></iframe></td>
  </tr>
</table>
